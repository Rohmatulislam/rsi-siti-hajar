...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="relative px-0 md:px-0 flex flex-col justify-center min-h-screen pt-16">
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            <div className="inline-flex items-center gap-3 bg-white/20 backdrop-blur-sm px-6 py-3 rounded-full border-white/30 mb-8 mx-auto">
            ...
            >
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight mb-4 max-w-6xl mx-auto text-center">
                <span className="block text-white/90 text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-light">
                  Rumah Sakit Islam
                  <br />
                  <span className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold italic tracking-tight text-shine">
                    Siti Hajar Mataram
                  </span>
                </span>
              </h1>

              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white max-w-4xl mx-auto leading-relaxed mb-6">
            ...
            <MotionDiv
              ...
              className="max-w-lg sm:max-w-xl md:max-w-2xl lg:max-w-3xl mx-auto relative mb-8"
            >
          ...
          <MotionDiv
            className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 xl:grid-cols-6 gap-4 max-w-4xl sm:max-w-5xl mx-auto mt-8"
            initial={{ y: 20, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
          ...
          >
            ...
            <Link href="/services/featured/executive" className="group relative block">
              <div className="bg-white/10 rounded-2xl p-5 text-center border border-white/20 hover:border-amber-400/50 hover:bg-white/30 hover:backdrop-blur-lg transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-2xl group-hover:shadow-amber-500/30 h-full">
                ...
                <h3 className="font-semibold text-white text-sm mb-1">Poli Executive</h3>
                <p className="text-[0.6rem] text-amber-200 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  Pelayanan Premium
                </p>
              </div>
