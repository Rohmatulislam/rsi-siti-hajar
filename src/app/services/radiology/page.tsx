...
import { RadiologyAppointmentForm } from "@/components/appointment/radiology-appointment-form";
import { Input } from '@/components/ui/input';
import { useState } from 'react';

// Data untuk paket-paket radiologi
const radiologyPackages = [
  ...
  {
    id: 3,
    name: "Paket USG Lengkap",
    price: 300000,
    discountPrice: 400000,
    description: "Pemeriksaan USG lengkap untuk berbagai organ",
    tests: [
      "USG Abdomen Lengkap",
  ...
  {
    id: 7,
    name: "Paket Mammografi",
    price: 400000,
    discountPrice: 550000,
    description: "Pemeriksaan deteksi dini kanker payudara",
    tests: [
      "Mammografi digital",
      "USG Payudara",
      "Interpretasi dokter spesialis",
  ...
  {
    id: 8,
    name: "Paket MRI Tulang Belakang",
    price: 1800000,
    discountPrice: 2200000,
    description: "Pemeriksaan gangguan saraf dan tulang belakang",
    tests: [
      "MRI Tulang Belakang",
      "Interpretasi dokter spesialis",
      "Konsultasi saraf"
...
export default function RadiologyServicePage() {
  ...
  const filteredPackages = radiologyPackages.filter(pkg => {
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-white/90 mt-4 max-w-2xl mx-auto">
              Pemeriksaan penunjang medis dengan peralatan canggih di RSI Siti Hajar Mataram
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="flex flex-wrap justify-center gap-6 text-center">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="font-medium">07:00 - 17:00 WITA</p>
              </div>
            </div>
            <div className="flex items-center">
              <div className="bg-emerald-100 rounded-full p-2 mr-3">
              ...
              <div>
                ...
                <p className="font-medium">Lantai 2, RSI Siti Hajar Mataram</p>
              </div>
            </div>
            <div className="flex items-center">
              <div className="bg-emerald-100 rounded-full p-2 mr-3">
          ...
          <div className="mb-8">
            <div className="flex flex-col md:flex-row gap-4 items-center">
              <div className="relative flex-grow max-w-2xl">
                ...
                <Input
                  type="text"
                  placeholder="Cari paket pemeriksaan radiologi..."
